CREATE TABLE [AM].[STAGE_ARTIFACT_CTRL_MASTER] (
    ...
    [IS_ENABLED_IND]             BIT            CONSTRAINT [STG_IS_ENABLED_IND] DEFAULT ((-1)) NOT NULL,
    [CREATED_DTE]                DATETIME       NOT NULL,
    [CREATED_BY]                 VARCHAR (50)   NOT NULL,
    [LAST_UPDT_DTE]              DATETIME       NULL,
    [LAST_UPDT_BY]               VARCHAR (50)   NULL,
    [LAST_CHG_LOAD_ID]           INT            NULL,
    CONSTRAINT [STG_PK_ARTIFACT_CTRL_DETAIL-ART_CTRL_MASTER_ID] PRIMARY KEY CLUSTERED ([ART_CTRL_MASTER_ID] ASC) WITH (FILLFACTOR = 95)
);
