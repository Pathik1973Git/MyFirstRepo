CREATE TABLE [AM].[ARTIFACT_PARAMETER] (
    ...
    CONSTRAINT [PK_ARTIFACT_PARAMETER-ART_ID-PARM_ID] PRIMARY KEY CLUSTERED ([ART_CTRL_MASTER_ID] ASC, [PARM_ID] ASC) WITH (FILLFACTOR = 95),
