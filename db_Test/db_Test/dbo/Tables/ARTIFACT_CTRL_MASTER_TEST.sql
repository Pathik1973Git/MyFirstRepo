CREATE TABLE [dbo].[ARTIFACT_CTRL_MASTER_TEST] (
    ...
    [ARC_LOAD_ID]                INT            NULL,
    CONSTRAINT [PK_ARTIFACT_CTRL_DETAIL_TEST-ART_CTRL_MASTER_ID] PRIMARY KEY CLUSTERED ([ART_CTRL_MASTER_ID] ASC) WITH (FILLFACTOR = 95)
);
