CREATE TABLE [dbo].[ARTIFACT_CTRL_MASTER_BACK] (
    ...
    CONSTRAINT [PK_ARTIFACT_CTRL_DETAIL_BACK-ART_CTRL_MASTER_ID] PRIMARY KEY CLUSTERED ([ART_CTRL_MASTER_ID] ASC) WITH (FILLFACTOR = 95)
);
