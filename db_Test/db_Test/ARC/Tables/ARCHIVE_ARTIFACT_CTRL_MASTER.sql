CREATE TABLE [ARC].[ARCHIVE_ARTIFACT_CTRL_MASTER] (
    [CHG_ID]                     INT            NOT NULL,
    ...
    CONSTRAINT [PK_ARC_ARTIFACT_CTRL_DETAIL] PRIMARY KEY CLUSTERED ([CHG_ID] ASC, [CHG_LOAD_ID] ASC, [ART_CTRL_MASTER_ID] ASC) WITH (FILLFACTOR = 95)
);
